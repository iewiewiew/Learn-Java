...
public class WebLogAspect {
    ...
    /**
     * 定义切点 切点为com.wmh.controller下所有的类
     * 其中类里的所有方法为连接点
     */
    @Pointcut("execution(* com.wmh.controller..*.*(..))")
    public void webLog() {
    }
    ...
    public Object webLogAround(ProceedingJoinPoint joinPoint) throws Throwable {
        //className的值：com.wmh.controller.DemoController
        String className = joinPoint.getTarget().getClass().getName();
        MethodSignature signature = (MethodSignature) joinPoint.getSignature();
        //方法名称示例：com.wmh.controller.DemoController.allDemo()
