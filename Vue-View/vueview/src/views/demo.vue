<template>
  <div class="app-container">
    ...
    <el-button :loading="downloadLoading" style="margin-left:16px;" type="primary" icon="el-icon-document" @click="handleDownload">
      导出 Excel
    </el-button>
    ...
    <el-table v-loading="loading" :data="tableData" border style="width: 100%">
      ...
      <el-table-column align="center" fixed="right" label="操作" width="200">
        <template slot-scope="scope">
          ...
          <el-button v-preventReClick type="danger" size="mini" @click="del(scope.row.id, 'id')">删除
          </el-button>
        </template>
      </el-table-column>
    </el-table>
  ...
  methods: {
    ...
    handleDownload() {
      ...
      import('@/vendor/Export2Excel').then(excel => {
        const tHeader = ['Id', 'Username', 'Password', 'Creater', 'Updater', 'CreateTime', 'UpdateTime']
        const filterVal = ['id', 'username', 'password', 'creater', 'updater', 'createTime', 'updateTime']
